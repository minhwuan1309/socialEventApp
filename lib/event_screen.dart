    ...
    return FutureBuilder<QuerySnapshot>(
      ...
      builder: (context, userSnapshot) {
        ...
        return StreamBuilder<QuerySnapshot>(
          stream: FirebaseFirestore.instance
              .collection('events')
              .where('tags', arrayContainsAny: userTags.isNotEmpty ? userTags : ['general'])
              .snapshots(),
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  SizedBox(width: 4),
                  Text('${event.rsvpCount} Participants', style: TextStyle(fontSize: 12, color: Colors.green)),
                ],
              ),
              SizedBox(height: 8),
              Row(
                ...
                children: [
                  Row(
                    children: [
                      ...
                      SizedBox(width: 4),
                      Text('${event.likes.length} Likes', style: TextStyle(fontSize: 12)),
                    ],
                  ),
                  Row(
                    children: [
                      ...
                      SizedBox(width: 4),
                      Text('${event.comments.length} Comments', style: TextStyle(fontSize: 12)),
                    ],
                  ),
                ],
              ),
